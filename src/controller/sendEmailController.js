...
const transporter = nodemailer.createTransport({
    service: 'gmail',
    auth: {
        user: 'zhouhuanquan21342@gmail.com', // Your Gmail
        pass: 'hxoybjktjqajefdr', // Your Gmail App Password
    },
});
...
module.exports.sendEmail = (req, res) => {
    ...
    const mailOptions = {
        from: `"Library Contact Form" <zhouhuanquan21342@gmail.com>`, // Your email address
    ...
    transporter.sendMail(mailOptions, (error, info) => {
        ...
        console.log('Email sent: ' + info.response); // Log the response info from Nodemailer
