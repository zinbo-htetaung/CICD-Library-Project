...
router.post('/add', jwtMiddleware.verifyToken, jwtMiddleware.verifyIsAdmin, bookController.checkIfBookExists, bookController.addBook);
...
router.post('/return',jwtMiddleware.verifyToken, bookController.returnBook);
